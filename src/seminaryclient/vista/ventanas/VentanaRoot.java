...
public class VentanaRoot extends javax.swing.JFrame{
    ...
    private boolean isActiveWindowEnable;
    private final RootEnable rootEnable;
    ...
    public VentanaRoot(String title) {
        ...
        this.rootEnable = new RootEnable();
        this.rootEnable.startEnable();
    }
    ...
    protected void setEnableWindow(boolean enable){
        if(enable){
            desbloquear();
        }else {
           bloquear();
    ...
    private void bloquear(){
        rootEnable.setIsEnable(true);
    }
    
    private void desbloquear(){
        rootEnable.setIsEnable(false);
    }
